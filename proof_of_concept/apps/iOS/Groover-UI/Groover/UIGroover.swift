...
public class UIGroover : NSObject {
    ...
    public dynamic class func drawMeasureCanvas(measureFrame: CGRect = CGRect(x: 0, y: 0, width: 79, height: 28), measureActive: Bool = true, measureProgress: CGFloat = 6) {
        //// General Declarations
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        let measureBorderPath = UIBezierPath(roundedRect: CGRect(x: measureFrame.minX + fastFloor(measureFrame.width * 0.03797 + 0.5), y: measureFrame.minY + fastFloor(measureFrame.height * 0.10714 - 0.5) + 1, width: fastFloor(measureFrame.width * 0.98734 + 0.5) - fastFloor(measureFrame.width * 0.03797 + 0.5), height: fastFloor(measureFrame.height * 0.89286 - 0.5) - fastFloor(measureFrame.height * 0.10714 - 0.5)), cornerRadius: 2)
