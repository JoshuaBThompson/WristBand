...
public class UIGroover : NSObject {
    ...
    public class func drawKnobCanvas(rotation rotation: CGFloat = 0, clickSelected: Bool = false, clickRingActive: Bool = false) {
        ...
        let gradientColor = UIColor(red: 0.113, green: 0.155, blue: 0.229, alpha: 1.000)
        let gradientColor2 = UIColor(red: 0.251, green: 0.306, blue: 0.364, alpha: 1.000)
        let gradientColor3 = UIColor(red: 0.104, green: 0.140, blue: 0.202, alpha: 1.000)

        //// Gradient Declarations
        let linearGradient1 = CGGradientCreateWithColors(CGColorSpaceCreateDeviceRGB(), [gradientColor.CGColor, gradientColor2.CGColor, gradientColor3.CGColor], [0, 0.51, 1])!

        //// Variable Declarations
        let clickColor = clickSelected ? lightBlue : clickGray

        //// knobBGFrame Drawing
        let knobBGFramePath = UIBezierPath(rect: CGRectMake(0, 0, 280, 280))
        ...
        knobrotationmaskTransformation = CGAffineTransformTranslate(knobrotationmaskTransformation, 140, 140)
        ...
        let rotationBGFramePath = UIBezierPath(rect: CGRectMake(0, 0, 280, 280))
        CGContextSaveGState(context)
        rotationBGFramePath.addClip()
        UIGroover.rotationBG.drawInRect(CGRectMake(0, 0, UIGroover.rotationBG.size.width, UIGroover.rotationBG.size.height))
        CGContextRestoreGState(context)
