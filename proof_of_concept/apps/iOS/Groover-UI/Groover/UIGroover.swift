...
public class UIGroover : NSObject {
    ...
    public dynamic class func drawKnobCanvas6and7plus(knobFrame: CGRect = CGRect(x: 0, y: -1, width: 456, height: 457), rotation: CGFloat = 0, clickSelected: Bool = false, clickRingActive: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Subframes
        let knobRotation: CGRect = CGRect(x: knobFrame.minX + fastFloor((knobFrame.width - 456) / 2 + 0.5), y: knobFrame.minY + fastFloor((knobFrame.height - 456) * 0.00000 + 0.5), width: 456, height: 456)
        let clickButton: CGRect = CGRect(x: knobFrame.minX + fastFloor((knobFrame.width - 49) * 0.48649 + 0.5), y: knobFrame.minY + fastFloor((knobFrame.height - 49) * 0.48284 + 0.5), width: 49, height: 49)
        ...
        //// Clip knob-rotation-mask
        let knobrotationmaskPath = UIBezierPath()
        knobrotationmaskPath.move(to: CGPoint(x: 0, y: 226.56))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 228, y: -1.44), controlPoint1: CGPoint(x: 125.92, y: 226.56), controlPoint2: CGPoint(x: 228, y: 124.48))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 0, y: -229.44), controlPoint1: CGPoint(x: 228, y: -127.36), controlPoint2: CGPoint(x: 125.92, y: -229.44))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -228, y: -1.44), controlPoint1: CGPoint(x: -125.92, y: -229.44), controlPoint2: CGPoint(x: -228, y: -127.36))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 0, y: 226.56), controlPoint1: CGPoint(x: -228, y: 124.48), controlPoint2: CGPoint(x: -125.92, y: 226.56))
        knobrotationmaskPath.addLine(to: CGPoint(x: 0, y: 226.56))
        knobrotationmaskPath.addLine(to: CGPoint(x: 0, y: 226.56))
        knobrotationmaskPath.addLine(to: CGPoint(x: 0, y: 226.56))
        knobrotationmaskPath.close()
        knobrotationmaskPath.move(to: CGPoint(x: -97.79, y: -204.11))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -121.19, y: -191.04), controlPoint1: CGPoint(x: -105.87, y: -200.21), controlPoint2: CGPoint(x: -113.68, y: -195.84))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -156.26, y: -152.12), controlPoint1: CGPoint(x: -132.09, y: -177.61), controlPoint2: CGPoint(x: -143.78, y: -164.62))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -191.03, y: -120.38), controlPoint1: CGPoint(x: -167.47, y: -140.9), controlPoint2: CGPoint(x: -179.07, y: -130.32))
        knobrotationmaskPath.addLine(to: CGPoint(x: -191.03, y: -120.38))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -200.84, y: -102.98), controlPoint1: CGPoint(x: -194.54, y: -114.74), controlPoint2: CGPoint(x: -197.82, y: -108.93))
        knobrotationmaskPath.addLine(to: CGPoint(x: -200.84, y: -102.98))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -200.17, y: -100.5), controlPoint1: CGPoint(x: -200.07, y: -102.43), controlPoint2: CGPoint(x: -199.77, y: -101.39))
        knobrotationmaskPath.addLine(to: CGPoint(x: -208.36, y: -82.08))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -210.56, y: -80.91), controlPoint1: CGPoint(x: -208.75, y: -81.21), controlPoint2: CGPoint(x: -209.66, y: -80.74))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -219.56, y: -50.87), controlPoint1: CGPoint(x: -214.23, y: -71.2), controlPoint2: CGPoint(x: -217.25, y: -61.17))
        knobrotationmaskPath.addLine(to: CGPoint(x: -219.56, y: -50.87))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -216.71, y: 3.03), controlPoint1: CGPoint(x: -217.68, y: -33.16), controlPoint2: CGPoint(x: -216.71, y: -15.18))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -218.94, y: 50.81), controlPoint1: CGPoint(x: -216.71, y: 19.14), controlPoint2: CGPoint(x: -217.47, y: 35.08))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -211.89, y: 74.6), controlPoint1: CGPoint(x: -217.02, y: 58.92), controlPoint2: CGPoint(x: -214.66, y: 66.86))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -209.73, y: 75.78), controlPoint1: CGPoint(x: -211.01, y: 74.47), controlPoint2: CGPoint(x: -210.11, y: 74.93))
        knobrotationmaskPath.addLine(to: CGPoint(x: -201.54, y: 94.2))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -202.53, y: 96.86), controlPoint1: CGPoint(x: -201.09, y: 95.22), controlPoint2: CGPoint(x: -201.52, y: 96.4))
        knobrotationmaskPath.addLine(to: CGPoint(x: -202.53, y: 96.86))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -189.17, y: 120.59), controlPoint1: CGPoint(x: -198.55, y: 105.06), controlPoint2: CGPoint(x: -194.08, y: 112.99))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -151.42, y: 154.81), controlPoint1: CGPoint(x: -176.16, y: 131.25), controlPoint2: CGPoint(x: -163.56, y: 142.65))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -120.32, y: 188.89), controlPoint1: CGPoint(x: -140.44, y: 165.8), controlPoint2: CGPoint(x: -130.07, y: 177.17))
        knobrotationmaskPath.addLine(to: CGPoint(x: -120.32, y: 188.89))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -99.24, y: 200.7), controlPoint1: CGPoint(x: -113.53, y: 193.19), controlPoint2: CGPoint(x: -106.5, y: 197.13))
        knobrotationmaskPath.addLine(to: CGPoint(x: -99.24, y: 200.7))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -96.98, y: 200.23), controlPoint1: CGPoint(x: -98.68, y: 200.11), controlPoint2: CGPoint(x: -97.77, y: 199.89))
        knobrotationmaskPath.addLine(to: CGPoint(x: -78.44, y: 208.11))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -77.21, y: 210.1), controlPoint1: CGPoint(x: -77.62, y: 208.45), controlPoint2: CGPoint(x: -77.15, y: 209.27))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -49.95, y: 218.11), controlPoint1: CGPoint(x: -68.37, y: 213.33), controlPoint2: CGPoint(x: -59.27, y: 216.01))
        knobrotationmaskPath.addLine(to: CGPoint(x: -49.95, y: 218.11))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 1.16, y: 215.55), controlPoint1: CGPoint(x: -33.14, y: 216.42), controlPoint2: CGPoint(x: -16.09, y: 215.55))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 50.21, y: 217.91), controlPoint1: CGPoint(x: 17.71, y: 215.55), controlPoint2: CGPoint(x: 34.07, y: 216.35))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 75.04, y: 210.65), controlPoint1: CGPoint(x: 58.68, y: 215.96), controlPoint2: CGPoint(x: 66.97, y: 213.53))
        knobrotationmaskPath.addLine(to: CGPoint(x: 74.91, y: 210.35))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 75.99, y: 207.7), controlPoint1: CGPoint(x: 74.48, y: 209.33), controlPoint2: CGPoint(x: 74.97, y: 208.14))
        knobrotationmaskPath.addLine(to: CGPoint(x: 94.53, y: 199.82))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 97.18, y: 200.89), controlPoint1: CGPoint(x: 95.56, y: 199.39), controlPoint2: CGPoint(x: 96.74, y: 199.86))
        knobrotationmaskPath.addLine(to: CGPoint(x: 97.35, y: 201.31))
        knobrotationmaskPath.addLine(to: CGPoint(x: 97.35, y: 201.31))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 118.68, y: 189.51), controlPoint1: CGPoint(x: 104.7, y: 197.75), controlPoint2: CGPoint(x: 111.81, y: 193.81))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 153.77, y: 150.59), controlPoint1: CGPoint(x: 129.59, y: 176.08), controlPoint2: CGPoint(x: 141.28, y: 163.09))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 190.84, y: 116.93), controlPoint1: CGPoint(x: 165.69, y: 138.65), controlPoint2: CGPoint(x: 178.07, y: 127.43))
        knobrotationmaskPath.addLine(to: CGPoint(x: 190.84, y: 116.93))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 201.14, y: 98.38), controlPoint1: CGPoint(x: 194.56, y: 110.93), controlPoint2: CGPoint(x: 198, y: 104.74))
        knobrotationmaskPath.addLine(to: CGPoint(x: 201.14, y: 98.38))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 200.23, y: 95.8), controlPoint1: CGPoint(x: 200.22, y: 97.89), controlPoint2: CGPoint(x: 199.82, y: 96.76))
        knobrotationmaskPath.addLine(to: CGPoint(x: 208.1, y: 77.23))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 210.69, y: 76.14), controlPoint1: CGPoint(x: 208.53, y: 76.22), controlPoint2: CGPoint(x: 209.67, y: 75.74))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 219.56, y: 45.19), controlPoint1: CGPoint(x: 214.35, y: 66.14), controlPoint2: CGPoint(x: 217.33, y: 55.8))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 217.38, y: -1.99), controlPoint1: CGPoint(x: 218.12, y: 29.66), controlPoint2: CGPoint(x: 217.38, y: 13.92))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 219.47, y: -48.28), controlPoint1: CGPoint(x: 217.38, y: -17.6), controlPoint2: CGPoint(x: 218.09, y: -33.04))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 211.25, y: -77.27), controlPoint1: CGPoint(x: 217.37, y: -58.2), controlPoint2: CGPoint(x: 214.62, y: -67.88))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 208.89, y: -78.44), controlPoint1: CGPoint(x: 210.3, y: -77.02), controlPoint2: CGPoint(x: 209.28, y: -77.51))
        knobrotationmaskPath.addLine(to: CGPoint(x: 201.01, y: -97.01))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 201.89, y: -99.56), controlPoint1: CGPoint(x: 200.61, y: -97.97), controlPoint2: CGPoint(x: 200.99, y: -99.07))
        knobrotationmaskPath.addLine(to: CGPoint(x: 201.89, y: -99.56))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 188.47, y: -123.39), controlPoint1: CGPoint(x: 197.89, y: -107.8), controlPoint2: CGPoint(x: 193.4, y: -115.75))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 152.92, y: -155.79), controlPoint1: CGPoint(x: 176.24, y: -133.52), controlPoint2: CGPoint(x: 164.37, y: -144.32))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 121.2, y: -190.62), controlPoint1: CGPoint(x: 141.71, y: -167.01), controlPoint2: CGPoint(x: 131.13, y: -178.64))
        knobrotationmaskPath.addLine(to: CGPoint(x: 121.2, y: -190.62))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 102.03, y: -201.68), controlPoint1: CGPoint(x: 115.01, y: -194.61), controlPoint2: CGPoint(x: 108.61, y: -198.3))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 99.75, y: -201.24), controlPoint1: CGPoint(x: 101.45, y: -201.09), controlPoint2: CGPoint(x: 100.54, y: -200.89))
        knobrotationmaskPath.addLine(to: CGPoint(x: 81.35, y: -209.44))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 80.15, y: -211.46), controlPoint1: CGPoint(x: 80.54, y: -209.8), controlPoint2: CGPoint(x: 80.08, y: -210.63))
        knobrotationmaskPath.addCurve(to: CGPoint(x: 48.5, y: -221), controlPoint1: CGPoint(x: 69.94, y: -215.39), controlPoint2: CGPoint(x: 59.37, y: -218.59))
        knobrotationmaskPath.addLine(to: CGPoint(x: 48.5, y: -221))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -0.44, y: -218.65), controlPoint1: CGPoint(x: 32.4, y: -219.44), controlPoint2: CGPoint(x: 16.07, y: -218.65))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -49.21, y: -220.98), controlPoint1: CGPoint(x: -16.89, y: -218.65), controlPoint2: CGPoint(x: -33.16, y: -219.44))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -75.47, y: -213.43), controlPoint1: CGPoint(x: -58.18, y: -218.99), controlPoint2: CGPoint(x: -66.94, y: -216.46))
        knobrotationmaskPath.addLine(to: CGPoint(x: -75.29, y: -212.99))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -76.38, y: -210.35), controlPoint1: CGPoint(x: -74.86, y: -211.96), controlPoint2: CGPoint(x: -75.36, y: -210.77))
        knobrotationmaskPath.addLine(to: CGPoint(x: -94.99, y: -202.63))
        knobrotationmaskPath.addCurve(to: CGPoint(x: -97.63, y: -203.72), controlPoint1: CGPoint(x: -96.02, y: -202.21), controlPoint2: CGPoint(x: -97.2, y: -202.69))
        knobrotationmaskPath.addLine(to: CGPoint(x: -97.79, y: -204.11))
        knobrotationmaskPath.addLine(to: CGPoint(x: -97.79, y: -204.11))
        knobrotationmaskPath.addLine(to: CGPoint(x: -97.79, y: -204.11))
        knobrotationmaskPath.addLine(to: CGPoint(x: -97.79, y: -204.11))
        knobrotationmaskPath.addLine(to: CGPoint(x: -97.79, y: -204.11))
        ...
        knobrotationmaskPath.usesEvenOddFillRule = true
        var knobrotationmaskTransformation = CGAffineTransform.identity
        knobrotationmaskTransformation = knobrotationmaskTransformation.translatedBy(x: knobRotation.minX + 228, y: knobRotation.minY + 229.44)
        knobrotationmaskTransformation = knobrotationmaskTransformation.rotated(by: -rotation * CGFloat.pi/180)
        knobrotationmaskPath.apply(knobrotationmaskTransformation)
        knobrotationmaskPath.addClip()
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: knobRotation.minX + fastFloor(knobRotation.width * 0.00000 + 0.5), y: knobRotation.minY + fastFloor(knobRotation.height * 0.00219 + 0.5), width: fastFloor(knobRotation.width * 1.00000 + 0.5) - fastFloor(knobRotation.width * 0.00000 + 0.5), height: fastFloor(knobRotation.height * 1.00219 + 0.5) - fastFloor(knobRotation.height * 0.00219 + 0.5)))
        context.saveGState()
        ovalPath.addClip()
        let ovalRotatedPath = UIBezierPath()
        ovalRotatedPath.append(ovalPath)
        ...
        //// bevel-8 Drawing
        let bevel8Path = UIBezierPath()
        bevel8Path.move(to: CGPoint(x: -123.29, y: -189.37))
        bevel8Path.addCurve(to: CGPoint(x: -193.34, y: -119.18), controlPoint1: CGPoint(x: -147.34, y: -160.67), controlPoint2: CGPoint(x: -159.31, y: -147.85))
        bevel8Path.addLine(to: CGPoint(x: -188.96, y: -125.43))
        bevel8Path.addCurve(to: CGPoint(x: -130.34, y: -184.26), controlPoint1: CGPoint(x: -163.03, y: -150.34), controlPoint2: CGPoint(x: -151.65, y: -160.37))
        bevel8Path.addLine(to: CGPoint(x: -123.29, y: -189.37))
        bevel8Path.close()
        bevel8Path.usesEvenOddFillRule = true
        context.saveGState()
        bevel8Path.addClip()
        context.drawLinearGradient(linearGradient1,
            start: CGPoint(x: -126.02, y: -189.42),
            end: CGPoint(x: -190.94, y: -124.48),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        ...
        //// bevel-7 Drawing
        let bevel7Path = UIBezierPath()
        bevel7Path.move(to: CGPoint(x: -220.11, y: -49.54))
        bevel7Path.addCurve(to: CGPoint(x: -220.14, y: 49.76), controlPoint1: CGPoint(x: -216.88, y: -12.19), controlPoint2: CGPoint(x: -216.3, y: 5.36))
        bevel7Path.addLine(to: CGPoint(x: -221.45, y: 42.23))
        bevel7Path.addCurve(to: CGPoint(x: -221.5, y: -40.93), controlPoint1: CGPoint(x: -220.69, y: 6.23), controlPoint2: CGPoint(x: -219.71, y: -8.92))
        bevel7Path.addLine(to: CGPoint(x: -220.11, y: -49.54))
        bevel7Path.close()
        bevel7Path.usesEvenOddFillRule = true
        context.saveGState()
        bevel7Path.addClip()
        context.drawLinearGradient(linearGradient1,
            start: CGPoint(x: -222.08, y: -47.63),
            end: CGPoint(x: -222.17, y: 44.3),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        ...
        //// bevel-6 Drawing
        let bevel6Path = UIBezierPath()
        bevel6Path.move(to: CGPoint(x: -188.75, y: 123.78))
        bevel6Path.addCurve(to: CGPoint(x: -118.73, y: 194.01), controlPoint1: CGPoint(x: -160.12, y: 147.9), controlPoint2: CGPoint(x: -147.33, y: 159.9))
        bevel6Path.addLine(to: CGPoint(x: -124.97, y: 189.62))
        bevel6Path.addCurve(to: CGPoint(x: -183.66, y: 130.86), controlPoint1: CGPoint(x: -149.82, y: 163.63), controlPoint2: CGPoint(x: -159.82, y: 152.22))
        bevel6Path.addLine(to: CGPoint(x: -188.75, y: 123.78))
        bevel6Path.close()
        bevel6Path.usesEvenOddFillRule = true
        context.saveGState()
        bevel6Path.addClip()
        context.drawLinearGradient(linearGradient1,
            start: CGPoint(x: -188.8, y: 126.53),
            end: CGPoint(x: -124.02, y: 191.6),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        ...
        //// bevel-5 Drawing
        let bevel5Path = UIBezierPath()
        bevel5Path.move(to: CGPoint(x: -49.27, y: 220.97))
        bevel5Path.addCurve(to: CGPoint(x: 49.78, y: 220.99), controlPoint1: CGPoint(x: -12.01, y: 217.73), controlPoint2: CGPoint(x: 5.49, y: 217.14))
        bevel5Path.addLine(to: CGPoint(x: 42.27, y: 222.31))
        bevel5Path.addCurve(to: CGPoint(x: -40.67, y: 222.36), controlPoint1: CGPoint(x: 6.37, y: 221.54), controlPoint2: CGPoint(x: -8.75, y: 220.57))
        bevel5Path.addLine(to: CGPoint(x: -49.27, y: 220.97))
        bevel5Path.close()
        bevel5Path.usesEvenOddFillRule = true
        context.saveGState()
        bevel5Path.addClip()
        context.drawLinearGradient(linearGradient1,
            start: CGPoint(x: -47.36, y: 222.94),
            end: CGPoint(x: 44.34, y: 223.03),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        ...
        //// bevel-4 Drawing
        let bevel4Path = UIBezierPath()
        bevel4Path.move(to: CGPoint(x: 119.39, y: 190.93))
        bevel4Path.addCurve(to: CGPoint(x: 189.45, y: 120.74), controlPoint1: CGPoint(x: 143.45, y: 162.23), controlPoint2: CGPoint(x: 155.41, y: 149.41))
        bevel4Path.addLine(to: CGPoint(x: 185.07, y: 126.99))
        bevel4Path.addCurve(to: CGPoint(x: 126.45, y: 185.83), controlPoint1: CGPoint(x: 159.13, y: 151.91), controlPoint2: CGPoint(x: 147.76, y: 161.93))
        bevel4Path.addLine(to: CGPoint(x: 119.39, y: 190.93))
        bevel4Path.close()
        bevel4Path.usesEvenOddFillRule = true
        context.saveGState()
        bevel4Path.addClip()
        context.drawLinearGradient(linearGradient1,
            start: CGPoint(x: 122.13, y: 190.98),
            end: CGPoint(x: 187.04, y: 126.04),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        ...
        //// bevel-3 Drawing
        let bevel3Path = UIBezierPath()
        bevel3Path.move(to: CGPoint(x: 220.54, y: 50.2))
        bevel3Path.addCurve(to: CGPoint(x: 221.08, y: -49.54), controlPoint1: CGPoint(x: 217.49, y: 12.7), controlPoint2: CGPoint(x: 216.99, y: -4.92))
        bevel3Path.addLine(to: CGPoint(x: 222.36, y: -41.98))
        bevel3Path.addCurve(to: CGPoint(x: 221.98, y: 41.54), controlPoint1: CGPoint(x: 221.41, y: -5.82), controlPoint2: CGPoint(x: 220.35, y: 9.4))
        bevel3Path.addLine(to: CGPoint(x: 220.54, y: 50.2))
        bevel3Path.close()
        bevel3Path.usesEvenOddFillRule = true
        context.saveGState()
        bevel3Path.addClip()
        context.drawLinearGradient(linearGradient1,
            start: CGPoint(x: 222.53, y: 48.27),
            end: CGPoint(x: 223.1, y: -44.07),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        ...
        //// bevel-2 Drawing
        let bevel2Path = UIBezierPath()
        bevel2Path.move(to: CGPoint(x: 189.88, y: -122.55))
        bevel2Path.addCurve(to: CGPoint(x: 121.47, y: -191.17), controlPoint1: CGPoint(x: 161.91, y: -146.11), controlPoint2: CGPoint(x: 149.41, y: -157.84))
        bevel2Path.addLine(to: CGPoint(x: 127.56, y: -186.88))
        bevel2Path.addCurve(to: CGPoint(x: 184.9, y: -129.46), controlPoint1: CGPoint(x: 151.84, y: -161.48), controlPoint2: CGPoint(x: 161.61, y: -150.34))
        bevel2Path.addLine(to: CGPoint(x: 189.88, y: -122.55))
        bevel2Path.close()
        bevel2Path.usesEvenOddFillRule = true
        context.saveGState()
        bevel2Path.addClip()
        context.drawLinearGradient(linearGradient1,
            start: CGPoint(x: 189.92, y: -125.23),
            end: CGPoint(x: 126.63, y: -188.81),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        ...
        //// bevel-1 Drawing
        let bevel1Path = UIBezierPath()
        bevel1Path.move(to: CGPoint(x: 50.35, y: -220.97))
        bevel1Path.addCurve(to: CGPoint(x: -48.7, y: -220.99), controlPoint1: CGPoint(x: 13.09, y: -217.73), controlPoint2: CGPoint(x: -4.41, y: -217.14))
        bevel1Path.addLine(to: CGPoint(x: -41.19, y: -222.31))
        bevel1Path.addCurve(to: CGPoint(x: 41.76, y: -222.36), controlPoint1: CGPoint(x: -5.28, y: -221.54), controlPoint2: CGPoint(x: 9.84, y: -220.57))
        bevel1Path.addLine(to: CGPoint(x: 50.35, y: -220.97))
        bevel1Path.close()
        bevel1Path.usesEvenOddFillRule = true
        context.saveGState()
        bevel1Path.addClip()
        context.drawLinearGradient(linearGradient1,
            start: CGPoint(x: 48.45, y: -222.94),
            end: CGPoint(x: -43.26, y: -223.03),
            options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
        context.restoreGState()
        ...
        if (clickRingActive) {
            //// clickRing Drawing
            let clickRingPath = UIBezierPath(ovalIn: CGRect(x: knobFrame.minX + fastFloor(knobFrame.width * 0.26316 + 0.5), y: knobFrame.minY + fastFloor(knobFrame.height * 0.26477 + 0.5), width: fastFloor(knobFrame.width * 0.71272 + 0.5) - fastFloor(knobFrame.width * 0.26316 + 0.5), height: fastFloor(knobFrame.height * 0.71116 + 0.5) - fastFloor(knobFrame.height * 0.26477 + 0.5)))
            UIGroover.lightBlue.setStroke()
            clickRingPath.lineWidth = 2
            clickRingPath.stroke()
        }
        ...
        //// clickOval7 Drawing
        context.saveGState()
        context.translateBy(x: clickButton.minX + 24.5, y: clickButton.minY + 42.88)

        let clickOval7Path = UIBezierPath(ovalIn: CGRect(x: -6.12, y: -6.12, width: 12.25, height: 12.25))
        clickColor.setFill()
        clickOval7Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval7Path.lineWidth = 1
        ...
        //// clickOval6 Drawing
        let clickOval6Path = UIBezierPath(ovalIn: CGRect(x: clickButton.minX, y: clickButton.minY + 37, width: 12, height: 12))
        clickColor.setFill()
        clickOval6Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval6Path.lineWidth = 1
        ...
        //// clickOval5 Drawing
        let clickOval5Path = UIBezierPath(ovalIn: CGRect(x: clickButton.minX + 37, y: clickButton.minY + 18, width: 12, height: 13))
        clickColor.setFill()
        clickOval5Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval5Path.lineWidth = 1
        ...
        //// clickOval4 Drawing
        let clickOval4Path = UIBezierPath(ovalIn: CGRect(x: clickButton.minX + 18, y: clickButton.minY + 18, width: 13, height: 13))
        clickColor.setFill()
        clickOval4Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval4Path.lineWidth = 1
        ...
        //// clickOval3 Drawing
        let clickOval3Path = UIBezierPath(ovalIn: CGRect(x: clickButton.minX, y: clickButton.minY + 18, width: 12, height: 13))
        clickColor.setFill()
        clickOval3Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval3Path.lineWidth = 1
        ...
        //// clickOval2 Drawing
        let clickOval2Path = UIBezierPath(ovalIn: CGRect(x: clickButton.minX + 37, y: clickButton.minY, width: 12, height: 12))
        clickColor.setFill()
        clickOval2Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval2Path.lineWidth = 1
        ...
        //// clickOval1 Drawing
        context.saveGState()
        context.translateBy(x: clickButton.minX + 24.5, y: clickButton.minY + 6.12)

        let clickOval1Path = UIBezierPath(ovalIn: CGRect(x: -6.12, y: -6.12, width: 12.25, height: 12.25))
        clickColor.setFill()
        clickOval1Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval1Path.lineWidth = 1
