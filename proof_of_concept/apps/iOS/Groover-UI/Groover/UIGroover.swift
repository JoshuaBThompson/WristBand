...
public class UIGroover : NSObject {
    ...
    public dynamic class func drawPopupButtonCanvas() {
    ...
    public dynamic class func drawQuantizationCanvas(quantizationFrame: CGRect = CGRect(x: 0, y: 0, width: 320, height: 54), quarterSelected: Bool = false, quarterActive: Bool = false, eighthSelected: Bool = false, eighthActive: Bool = false, sixteenthSelected: Bool = false, sixteenthActive: Bool = false, thirtysecondSelected: Bool = false, thirtysecondActive: Bool = false, tripletSelected: Bool = false, tripletActive: Bool = false) {
        ...
        //// Subframes
        let tripletFrame = CGRect(x: quantizationFrame.minX + 250, y: quantizationFrame.minY, width: 54, height: 54)
        let thirtySecondFrame = CGRect(x: quantizationFrame.minX + 192, y: quantizationFrame.minY, width: 54, height: 54)
        let frame = CGRect(x: quantizationFrame.minX + 133, y: quantizationFrame.minY, width: 54, height: 54)
        let eighthFrame = CGRect(x: quantizationFrame.minX + 76, y: quantizationFrame.minY, width: 54, height: 54)
        let quarterFrame = CGRect(x: quantizationFrame.minX + 16, y: quantizationFrame.minY, width: 54, height: 54)
        ...
        if (tripletDeselected) {
            ...
            tripletLightPath.move(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 34.5))
            tripletLightPath.addLine(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 21.67))
            tripletLightPath.addLine(to: CGPoint(x: tripletFrame.minX + 271, y: tripletFrame.minY + 21.67))
            tripletLightPath.addLine(to: CGPoint(x: tripletFrame.minX + 271, y: tripletFrame.minY + 19))
            tripletLightPath.addLine(to: CGPoint(x: tripletFrame.minX + 283.32, y: tripletFrame.minY + 19))
            tripletLightPath.addLine(to: CGPoint(x: tripletFrame.minX + 283.32, y: tripletFrame.minY + 21.67))
            tripletLightPath.addLine(to: CGPoint(x: tripletFrame.minX + 278.78, y: tripletFrame.minY + 21.67))
            tripletLightPath.addLine(to: CGPoint(x: tripletFrame.minX + 278.78, y: tripletFrame.minY + 34.5))
            tripletLightPath.addLine(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 34.5))
        ...
        if (tripletActive) {
            ...
            tripletDarkPath.move(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 34.5))
            tripletDarkPath.addLine(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 21.67))
            tripletDarkPath.addLine(to: CGPoint(x: tripletFrame.minX + 271, y: tripletFrame.minY + 21.67))
            tripletDarkPath.addLine(to: CGPoint(x: tripletFrame.minX + 271, y: tripletFrame.minY + 19))
            tripletDarkPath.addLine(to: CGPoint(x: tripletFrame.minX + 283.32, y: tripletFrame.minY + 19))
            tripletDarkPath.addLine(to: CGPoint(x: tripletFrame.minX + 283.32, y: tripletFrame.minY + 21.67))
            tripletDarkPath.addLine(to: CGPoint(x: tripletFrame.minX + 278.78, y: tripletFrame.minY + 21.67))
            tripletDarkPath.addLine(to: CGPoint(x: tripletFrame.minX + 278.78, y: tripletFrame.minY + 34.5))
            tripletDarkPath.addLine(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 34.5))
        ...
        if (tripletSelected) {
            ...
            tripletBluePath.move(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 34.5))
            tripletBluePath.addLine(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 21.67))
            tripletBluePath.addLine(to: CGPoint(x: tripletFrame.minX + 271, y: tripletFrame.minY + 21.67))
            tripletBluePath.addLine(to: CGPoint(x: tripletFrame.minX + 271, y: tripletFrame.minY + 19))
            tripletBluePath.addLine(to: CGPoint(x: tripletFrame.minX + 283.32, y: tripletFrame.minY + 19))
            tripletBluePath.addLine(to: CGPoint(x: tripletFrame.minX + 283.32, y: tripletFrame.minY + 21.67))
            tripletBluePath.addLine(to: CGPoint(x: tripletFrame.minX + 278.78, y: tripletFrame.minY + 21.67))
            tripletBluePath.addLine(to: CGPoint(x: tripletFrame.minX + 278.78, y: tripletFrame.minY + 34.5))
            tripletBluePath.addLine(to: CGPoint(x: tripletFrame.minX + 275.53, y: tripletFrame.minY + 34.5))
        ...
        if (thirtysecondDeselected) {
            ...
            thirtysecondLightPath.move(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 22))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 22))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 19))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 19))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 18))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 18))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 17))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 17))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 14))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.05, y: thirtySecondFrame.minY + 14))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 222.61, y: thirtySecondFrame.minY + 14))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 222.61, y: thirtySecondFrame.minY + 14))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 221.48, y: thirtySecondFrame.minY + 14))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 221.48, y: thirtySecondFrame.minY + 32.48))
            thirtysecondLightPath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 216.92, y: thirtySecondFrame.minY + 33.14), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 220.27, y: thirtySecondFrame.minY + 32.33), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 218.63, y: thirtySecondFrame.minY + 32.55))
            thirtysecondLightPath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 212.06, y: thirtySecondFrame.minY + 37.45), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 213.78, y: thirtySecondFrame.minY + 34.22), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 211.61, y: thirtySecondFrame.minY + 36.15))
            thirtysecondLightPath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 218.55, y: thirtySecondFrame.minY + 37.86), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 212.51, y: thirtySecondFrame.minY + 38.76), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 215.41, y: thirtySecondFrame.minY + 38.94))
            thirtysecondLightPath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 223.46, y: thirtySecondFrame.minY + 34), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 221.33, y: thirtySecondFrame.minY + 36.9), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 223.36, y: thirtySecondFrame.minY + 35.27))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.46, y: thirtySecondFrame.minY + 34))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 34))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 27))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 27))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 24))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
            thirtysecondLightPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
        ...
        if (thirtysecondActive) {
            ...
            thirtysecondDarkPath.move(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 22))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 22))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 19))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 19))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 18))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 18))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 17))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 17))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 14))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.05, y: thirtySecondFrame.minY + 14))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 222.61, y: thirtySecondFrame.minY + 14))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 222.61, y: thirtySecondFrame.minY + 14))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 221.48, y: thirtySecondFrame.minY + 14))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 221.48, y: thirtySecondFrame.minY + 32.48))
            thirtysecondDarkPath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 216.92, y: thirtySecondFrame.minY + 33.14), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 220.27, y: thirtySecondFrame.minY + 32.33), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 218.63, y: thirtySecondFrame.minY + 32.55))
            thirtysecondDarkPath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 212.06, y: thirtySecondFrame.minY + 37.45), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 213.78, y: thirtySecondFrame.minY + 34.22), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 211.61, y: thirtySecondFrame.minY + 36.15))
            thirtysecondDarkPath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 218.55, y: thirtySecondFrame.minY + 37.86), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 212.51, y: thirtySecondFrame.minY + 38.76), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 215.41, y: thirtySecondFrame.minY + 38.94))
            thirtysecondDarkPath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 223.46, y: thirtySecondFrame.minY + 34), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 221.33, y: thirtySecondFrame.minY + 36.9), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 223.36, y: thirtySecondFrame.minY + 35.27))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.46, y: thirtySecondFrame.minY + 34))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 34))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 27))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 27))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 24))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
            thirtysecondDarkPath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
        ...
        if (thirtysecondSelected) {
            ...
            thirtysecondBluePath.move(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 22))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 22))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 19))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 19))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 18))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 18))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 17))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 17))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 14))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.05, y: thirtySecondFrame.minY + 14))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 222.61, y: thirtySecondFrame.minY + 14))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 222.61, y: thirtySecondFrame.minY + 14))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 221.48, y: thirtySecondFrame.minY + 14))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 221.48, y: thirtySecondFrame.minY + 32.48))
            thirtysecondBluePath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 216.92, y: thirtySecondFrame.minY + 33.14), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 220.27, y: thirtySecondFrame.minY + 32.33), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 218.63, y: thirtySecondFrame.minY + 32.55))
            thirtysecondBluePath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 212.06, y: thirtySecondFrame.minY + 37.45), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 213.78, y: thirtySecondFrame.minY + 34.22), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 211.61, y: thirtySecondFrame.minY + 36.15))
            thirtysecondBluePath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 218.55, y: thirtySecondFrame.minY + 37.86), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 212.51, y: thirtySecondFrame.minY + 38.76), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 215.41, y: thirtySecondFrame.minY + 38.94))
            thirtysecondBluePath.addCurve(to: CGPoint(x: thirtySecondFrame.minX + 223.46, y: thirtySecondFrame.minY + 34), controlPoint1: CGPoint(x: thirtySecondFrame.minX + 221.33, y: thirtySecondFrame.minY + 36.9), controlPoint2: CGPoint(x: thirtySecondFrame.minX + 223.36, y: thirtySecondFrame.minY + 35.27))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.46, y: thirtySecondFrame.minY + 34))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 34))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.48, y: thirtySecondFrame.minY + 27))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 27))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 229.5, y: thirtySecondFrame.minY + 24))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
            thirtysecondBluePath.addLine(to: CGPoint(x: thirtySecondFrame.minX + 223.5, y: thirtySecondFrame.minY + 24))
        ...
        if (sixteenthDeselected) {
            ...
            sixteenthLightPath.move(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 34))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 164.46, y: frame.minY + 34))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 164.46, y: frame.minY + 34))
            sixteenthLightPath.addCurve(to: CGPoint(x: frame.minX + 159.55, y: frame.minY + 37.86), controlPoint1: CGPoint(x: frame.minX + 164.36, y: frame.minY + 35.27), controlPoint2: CGPoint(x: frame.minX + 162.33, y: frame.minY + 36.9))
            sixteenthLightPath.addCurve(to: CGPoint(x: frame.minX + 153.06, y: frame.minY + 37.45), controlPoint1: CGPoint(x: frame.minX + 156.41, y: frame.minY + 38.94), controlPoint2: CGPoint(x: frame.minX + 153.51, y: frame.minY + 38.76))
            sixteenthLightPath.addCurve(to: CGPoint(x: frame.minX + 157.92, y: frame.minY + 33.14), controlPoint1: CGPoint(x: frame.minX + 152.61, y: frame.minY + 36.15), controlPoint2: CGPoint(x: frame.minX + 154.78, y: frame.minY + 34.22))
            sixteenthLightPath.addCurve(to: CGPoint(x: frame.minX + 162.48, y: frame.minY + 32.48), controlPoint1: CGPoint(x: frame.minX + 159.63, y: frame.minY + 32.55), controlPoint2: CGPoint(x: frame.minX + 161.27, y: frame.minY + 32.33))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 162.48, y: frame.minY + 14))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 163.61, y: frame.minY + 14))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 163.61, y: frame.minY + 14))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 14))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 18))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 18))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 21))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 21))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 25))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
            sixteenthLightPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
        ...
        if (sixteenthActive) {
            ...
            sixteenthDarkPath.move(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 34))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 164.46, y: frame.minY + 34))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 164.46, y: frame.minY + 34))
            sixteenthDarkPath.addCurve(to: CGPoint(x: frame.minX + 159.55, y: frame.minY + 37.86), controlPoint1: CGPoint(x: frame.minX + 164.36, y: frame.minY + 35.27), controlPoint2: CGPoint(x: frame.minX + 162.33, y: frame.minY + 36.9))
            sixteenthDarkPath.addCurve(to: CGPoint(x: frame.minX + 153.06, y: frame.minY + 37.45), controlPoint1: CGPoint(x: frame.minX + 156.41, y: frame.minY + 38.94), controlPoint2: CGPoint(x: frame.minX + 153.51, y: frame.minY + 38.76))
            sixteenthDarkPath.addCurve(to: CGPoint(x: frame.minX + 157.92, y: frame.minY + 33.14), controlPoint1: CGPoint(x: frame.minX + 152.61, y: frame.minY + 36.15), controlPoint2: CGPoint(x: frame.minX + 154.78, y: frame.minY + 34.22))
            sixteenthDarkPath.addCurve(to: CGPoint(x: frame.minX + 162.48, y: frame.minY + 32.48), controlPoint1: CGPoint(x: frame.minX + 159.63, y: frame.minY + 32.55), controlPoint2: CGPoint(x: frame.minX + 161.27, y: frame.minY + 32.33))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 162.48, y: frame.minY + 14))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 163.61, y: frame.minY + 14))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 163.61, y: frame.minY + 14))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 14))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 18))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 18))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 21))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 21))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 25))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
            sixteenthDarkPath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
        ...
        if (sixteenthSelected) {
            ...
            sixteenthBluePath.move(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 34))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 164.46, y: frame.minY + 34))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 164.46, y: frame.minY + 34))
            sixteenthBluePath.addCurve(to: CGPoint(x: frame.minX + 159.55, y: frame.minY + 37.86), controlPoint1: CGPoint(x: frame.minX + 164.36, y: frame.minY + 35.27), controlPoint2: CGPoint(x: frame.minX + 162.33, y: frame.minY + 36.9))
            sixteenthBluePath.addCurve(to: CGPoint(x: frame.minX + 153.06, y: frame.minY + 37.45), controlPoint1: CGPoint(x: frame.minX + 156.41, y: frame.minY + 38.94), controlPoint2: CGPoint(x: frame.minX + 153.51, y: frame.minY + 38.76))
            sixteenthBluePath.addCurve(to: CGPoint(x: frame.minX + 157.92, y: frame.minY + 33.14), controlPoint1: CGPoint(x: frame.minX + 152.61, y: frame.minY + 36.15), controlPoint2: CGPoint(x: frame.minX + 154.78, y: frame.minY + 34.22))
            sixteenthBluePath.addCurve(to: CGPoint(x: frame.minX + 162.48, y: frame.minY + 32.48), controlPoint1: CGPoint(x: frame.minX + 159.63, y: frame.minY + 32.55), controlPoint2: CGPoint(x: frame.minX + 161.27, y: frame.minY + 32.33))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 162.48, y: frame.minY + 14))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 163.61, y: frame.minY + 14))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 163.61, y: frame.minY + 14))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 14))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 18))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 18))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 21))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 21))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 170.73, y: frame.minY + 25))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
            sixteenthBluePath.addLine(to: CGPoint(x: frame.minX + 164.48, y: frame.minY + 25))
        ...
        if (eighthDeselected) {
            ...
            eighthLightPath.move(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 105.48, y: eighthFrame.minY + 14))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 105.48, y: eighthFrame.minY + 32.48))
            eighthLightPath.addCurve(to: CGPoint(x: eighthFrame.minX + 100.92, y: eighthFrame.minY + 33.14), controlPoint1: CGPoint(x: eighthFrame.minX + 104.27, y: eighthFrame.minY + 32.33), controlPoint2: CGPoint(x: eighthFrame.minX + 102.63, y: eighthFrame.minY + 32.55))
            eighthLightPath.addCurve(to: CGPoint(x: eighthFrame.minX + 96.06, y: eighthFrame.minY + 37.45), controlPoint1: CGPoint(x: eighthFrame.minX + 97.78, y: eighthFrame.minY + 34.22), controlPoint2: CGPoint(x: eighthFrame.minX + 95.61, y: eighthFrame.minY + 36.15))
            eighthLightPath.addCurve(to: CGPoint(x: eighthFrame.minX + 102.55, y: eighthFrame.minY + 37.86), controlPoint1: CGPoint(x: eighthFrame.minX + 96.51, y: eighthFrame.minY + 38.76), controlPoint2: CGPoint(x: eighthFrame.minX + 99.41, y: eighthFrame.minY + 38.94))
            eighthLightPath.addCurve(to: CGPoint(x: eighthFrame.minX + 107.46, y: eighthFrame.minY + 34), controlPoint1: CGPoint(x: eighthFrame.minX + 105.33, y: eighthFrame.minY + 36.9), controlPoint2: CGPoint(x: eighthFrame.minX + 107.36, y: eighthFrame.minY + 35.27))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 107.46, y: eighthFrame.minY + 34))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 107.48, y: eighthFrame.minY + 34))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 107.48, y: eighthFrame.minY + 18))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 113.73, y: eighthFrame.minY + 18))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 113.73, y: eighthFrame.minY + 14))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
            eighthLightPath.addLine(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
        ...
        if (eighthActive) {
            ...
            eighthDarkPath.move(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 105.48, y: eighthFrame.minY + 14))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 105.48, y: eighthFrame.minY + 32.48))
            eighthDarkPath.addCurve(to: CGPoint(x: eighthFrame.minX + 100.92, y: eighthFrame.minY + 33.14), controlPoint1: CGPoint(x: eighthFrame.minX + 104.27, y: eighthFrame.minY + 32.33), controlPoint2: CGPoint(x: eighthFrame.minX + 102.63, y: eighthFrame.minY + 32.55))
            eighthDarkPath.addCurve(to: CGPoint(x: eighthFrame.minX + 96.06, y: eighthFrame.minY + 37.45), controlPoint1: CGPoint(x: eighthFrame.minX + 97.78, y: eighthFrame.minY + 34.22), controlPoint2: CGPoint(x: eighthFrame.minX + 95.61, y: eighthFrame.minY + 36.15))
            eighthDarkPath.addCurve(to: CGPoint(x: eighthFrame.minX + 102.55, y: eighthFrame.minY + 37.86), controlPoint1: CGPoint(x: eighthFrame.minX + 96.51, y: eighthFrame.minY + 38.76), controlPoint2: CGPoint(x: eighthFrame.minX + 99.41, y: eighthFrame.minY + 38.94))
            eighthDarkPath.addCurve(to: CGPoint(x: eighthFrame.minX + 107.46, y: eighthFrame.minY + 34), controlPoint1: CGPoint(x: eighthFrame.minX + 105.33, y: eighthFrame.minY + 36.9), controlPoint2: CGPoint(x: eighthFrame.minX + 107.36, y: eighthFrame.minY + 35.27))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 107.46, y: eighthFrame.minY + 34))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 107.48, y: eighthFrame.minY + 34))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 107.48, y: eighthFrame.minY + 18))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 113.73, y: eighthFrame.minY + 18))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 113.73, y: eighthFrame.minY + 14))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
            eighthDarkPath.addLine(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
        ...
        if (eighthSelected) {
            ...
            eighthBluePath.move(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 105.48, y: eighthFrame.minY + 14))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 105.48, y: eighthFrame.minY + 32.48))
            eighthBluePath.addCurve(to: CGPoint(x: eighthFrame.minX + 100.92, y: eighthFrame.minY + 33.14), controlPoint1: CGPoint(x: eighthFrame.minX + 104.27, y: eighthFrame.minY + 32.33), controlPoint2: CGPoint(x: eighthFrame.minX + 102.63, y: eighthFrame.minY + 32.55))
            eighthBluePath.addCurve(to: CGPoint(x: eighthFrame.minX + 96.06, y: eighthFrame.minY + 37.45), controlPoint1: CGPoint(x: eighthFrame.minX + 97.78, y: eighthFrame.minY + 34.22), controlPoint2: CGPoint(x: eighthFrame.minX + 95.61, y: eighthFrame.minY + 36.15))
            eighthBluePath.addCurve(to: CGPoint(x: eighthFrame.minX + 102.55, y: eighthFrame.minY + 37.86), controlPoint1: CGPoint(x: eighthFrame.minX + 96.51, y: eighthFrame.minY + 38.76), controlPoint2: CGPoint(x: eighthFrame.minX + 99.41, y: eighthFrame.minY + 38.94))
            eighthBluePath.addCurve(to: CGPoint(x: eighthFrame.minX + 107.46, y: eighthFrame.minY + 34), controlPoint1: CGPoint(x: eighthFrame.minX + 105.33, y: eighthFrame.minY + 36.9), controlPoint2: CGPoint(x: eighthFrame.minX + 107.36, y: eighthFrame.minY + 35.27))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 107.46, y: eighthFrame.minY + 34))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 107.48, y: eighthFrame.minY + 34))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 107.48, y: eighthFrame.minY + 18))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 113.73, y: eighthFrame.minY + 18))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 113.73, y: eighthFrame.minY + 14))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
            eighthBluePath.addLine(to: CGPoint(x: eighthFrame.minX + 106.61, y: eighthFrame.minY + 14))
        ...
        if (quarterDeselected) {
            ...
            quarterLightPath.move(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
            quarterLightPath.addCurve(to: CGPoint(x: quarterFrame.minX + 42.55, y: quarterFrame.minY + 37.86), controlPoint1: CGPoint(x: quarterFrame.minX + 47.36, y: quarterFrame.minY + 35.27), controlPoint2: CGPoint(x: quarterFrame.minX + 45.33, y: quarterFrame.minY + 36.9))
            quarterLightPath.addCurve(to: CGPoint(x: quarterFrame.minX + 36.06, y: quarterFrame.minY + 37.45), controlPoint1: CGPoint(x: quarterFrame.minX + 39.41, y: quarterFrame.minY + 38.94), controlPoint2: CGPoint(x: quarterFrame.minX + 36.51, y: quarterFrame.minY + 38.76))
            quarterLightPath.addCurve(to: CGPoint(x: quarterFrame.minX + 40.92, y: quarterFrame.minY + 33.14), controlPoint1: CGPoint(x: quarterFrame.minX + 35.61, y: quarterFrame.minY + 36.15), controlPoint2: CGPoint(x: quarterFrame.minX + 37.78, y: quarterFrame.minY + 34.22))
            quarterLightPath.addCurve(to: CGPoint(x: quarterFrame.minX + 45.48, y: quarterFrame.minY + 32.48), controlPoint1: CGPoint(x: quarterFrame.minX + 42.63, y: quarterFrame.minY + 32.55), controlPoint2: CGPoint(x: quarterFrame.minX + 44.27, y: quarterFrame.minY + 32.33))
            quarterLightPath.addLine(to: CGPoint(x: quarterFrame.minX + 45.48, y: quarterFrame.minY + 14))
            quarterLightPath.addLine(to: CGPoint(x: quarterFrame.minX + 47.48, y: quarterFrame.minY + 14))
            quarterLightPath.addLine(to: CGPoint(x: quarterFrame.minX + 47.48, y: quarterFrame.minY + 34))
            quarterLightPath.addLine(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
            quarterLightPath.addLine(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
        ...
        if (quarterActive) {
            ...
            quarterDarkPath.move(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
            quarterDarkPath.addCurve(to: CGPoint(x: quarterFrame.minX + 42.55, y: quarterFrame.minY + 37.86), controlPoint1: CGPoint(x: quarterFrame.minX + 47.36, y: quarterFrame.minY + 35.27), controlPoint2: CGPoint(x: quarterFrame.minX + 45.33, y: quarterFrame.minY + 36.9))
            quarterDarkPath.addCurve(to: CGPoint(x: quarterFrame.minX + 36.06, y: quarterFrame.minY + 37.45), controlPoint1: CGPoint(x: quarterFrame.minX + 39.41, y: quarterFrame.minY + 38.94), controlPoint2: CGPoint(x: quarterFrame.minX + 36.51, y: quarterFrame.minY + 38.76))
            quarterDarkPath.addCurve(to: CGPoint(x: quarterFrame.minX + 40.92, y: quarterFrame.minY + 33.14), controlPoint1: CGPoint(x: quarterFrame.minX + 35.61, y: quarterFrame.minY + 36.15), controlPoint2: CGPoint(x: quarterFrame.minX + 37.78, y: quarterFrame.minY + 34.22))
            quarterDarkPath.addCurve(to: CGPoint(x: quarterFrame.minX + 45.48, y: quarterFrame.minY + 32.48), controlPoint1: CGPoint(x: quarterFrame.minX + 42.63, y: quarterFrame.minY + 32.55), controlPoint2: CGPoint(x: quarterFrame.minX + 44.27, y: quarterFrame.minY + 32.33))
            quarterDarkPath.addLine(to: CGPoint(x: quarterFrame.minX + 45.48, y: quarterFrame.minY + 14))
            quarterDarkPath.addLine(to: CGPoint(x: quarterFrame.minX + 47.48, y: quarterFrame.minY + 14))
            quarterDarkPath.addLine(to: CGPoint(x: quarterFrame.minX + 47.48, y: quarterFrame.minY + 34))
            quarterDarkPath.addLine(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
            quarterDarkPath.addLine(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
        ...
        if (quarterSelected) {
            ...
            quarterBluePath.move(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
            quarterBluePath.addCurve(to: CGPoint(x: quarterFrame.minX + 42.55, y: quarterFrame.minY + 37.86), controlPoint1: CGPoint(x: quarterFrame.minX + 47.36, y: quarterFrame.minY + 35.27), controlPoint2: CGPoint(x: quarterFrame.minX + 45.33, y: quarterFrame.minY + 36.9))
            quarterBluePath.addCurve(to: CGPoint(x: quarterFrame.minX + 36.06, y: quarterFrame.minY + 37.45), controlPoint1: CGPoint(x: quarterFrame.minX + 39.41, y: quarterFrame.minY + 38.94), controlPoint2: CGPoint(x: quarterFrame.minX + 36.51, y: quarterFrame.minY + 38.76))
            quarterBluePath.addCurve(to: CGPoint(x: quarterFrame.minX + 40.92, y: quarterFrame.minY + 33.14), controlPoint1: CGPoint(x: quarterFrame.minX + 35.61, y: quarterFrame.minY + 36.15), controlPoint2: CGPoint(x: quarterFrame.minX + 37.78, y: quarterFrame.minY + 34.22))
            quarterBluePath.addCurve(to: CGPoint(x: quarterFrame.minX + 45.48, y: quarterFrame.minY + 32.48), controlPoint1: CGPoint(x: quarterFrame.minX + 42.63, y: quarterFrame.minY + 32.55), controlPoint2: CGPoint(x: quarterFrame.minX + 44.27, y: quarterFrame.minY + 32.33))
            quarterBluePath.addLine(to: CGPoint(x: quarterFrame.minX + 45.48, y: quarterFrame.minY + 14))
            quarterBluePath.addLine(to: CGPoint(x: quarterFrame.minX + 47.48, y: quarterFrame.minY + 14))
            quarterBluePath.addLine(to: CGPoint(x: quarterFrame.minX + 47.48, y: quarterFrame.minY + 34))
            quarterBluePath.addLine(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
            quarterBluePath.addLine(to: CGPoint(x: quarterFrame.minX + 47.46, y: quarterFrame.minY + 34))
    ...
    public dynamic class func drawTransportCanvas(playSelected: Bool = false, recordSelected: Bool = false) {
        ...
        //// Frames
        let recordFrame = CGRect(x: 87, y: 0, width: 87, height: 56)
    ...
    public dynamic class func drawMeasureCanvas(measureFrame: CGRect = CGRect(x: 0, y: 0, width: 81, height: 28), measureActive: Bool = true, measureProgress: CGFloat = 30) {
