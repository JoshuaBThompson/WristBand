//
//  Instrument2Presets.swift
//  MidiDevice_TCL_V0.0.0
//
//  Created by sofiebio on 5/8/16.
...
class Instrument2Preset1: SynthInstrument{
    ...
    init(voiceCount: Int) {
        super.init(instrumentVoice: Instrument2Preset1Voice(), voiceCount: voiceCount)
        note = 90
...
class Instrument2Preset1Voice: SynthInstrumentVoice{
    ...
    override init() {
        ...
        bitCrush = AKBitCrusher(compressor)
        ...
        super.init()
        //set avaudionode
        self.avAudioNode = bitCrush.avAudioNode //prestMixer.avAudioNode
...
class Instrument2Preset2: SynthInstrument{
    /// Create the synth snare instrument
    ///
    /// - parameter voiceCount: Number of voices (usually two is plenty for drums)
    ///
    ...
    init(voiceCount: Int) {
        super.init(instrumentVoice: Instrument2Preset2Voice(), voiceCount: voiceCount)
        note = 80
...
class Instrument2Preset2Voice: SynthInstrumentVoice{
...
class Instrument2Preset3: SynthInstrument{
    /// Create the synth snare instrument
    ///
    /// - parameter voiceCount: Number of voices (usually two is plenty for drums)
    ///
    ...
    init(voiceCount: Int) {
        super.init(instrumentVoice: Instrument2Preset3Voice(), voiceCount: voiceCount)
        note = 70
...
class Instrument2Preset3Voice: SynthInstrumentVoice{
    ...
    /// Create the synth drum voice
    override init() {
        frequency = AKOperation.lineSegment(AKOperation.trigger, start: 180.0, end: 120.0, duration: 0.20)
        triangleWave = AKOperation.triangleWave(frequency: frequency, amplitude: 1)
        triangleTrigger = triangleWave.triggeredWithEnvelope(AKOperation.trigger, attack: 0.0001, hold: 0.0, release: 0.20)
        waveGenerator = AKOperationGenerator(operation: triangleTrigger)
...
class Instrument2Preset4: SynthInstrument{
    /// Create the synth snare instrument
    ///
    /// - parameter voiceCount: Number of voices (usually two is plenty for drums)
    ///
    ...
    init(voiceCount: Int) {
        super.init(instrumentVoice: Instrument2Preset4Voice(), voiceCount: voiceCount)
        note = 60
...
class Instrument2Preset4Voice: SynthInstrumentVoice{
    ...
    /// Create the synth drum voice
    override init() {
        frequency = AKOperation.lineSegment(AKOperation.trigger, start: 130.0, end: 20.0, duration: 0.20)
        triangleWave = AKOperation.triangleWave(frequency: frequency, amplitude: 1)
        triangleTrigger = triangleWave.triggeredWithEnvelope(AKOperation.trigger, attack: 0.0001, hold: 0.0, release: 0.20)
        waveGenerator = AKOperationGenerator(operation: triangleTrigger)
