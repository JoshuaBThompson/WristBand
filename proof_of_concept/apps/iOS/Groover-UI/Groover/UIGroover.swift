...
public class UIGroover : NSObject {
    ...
    public dynamic class func drawSoundParametersCanvas(soundParamteresFrame: CGRect = CGRect(x: 0, y: 0, width: 42, height: 42), soundParametersSelected: Bool = false) {
        ...
        let soundParametersBasePath = UIBezierPath(ovalIn: CGRect(x: soundParamteresFrame.minX + 1, y: soundParamteresFrame.minY + 1, width: soundParamteresFrame.width - 2, height: soundParamteresFrame.height - 2))
        UIGroover.soundParamtersBG.setFill()
        soundParametersBasePath.fill()


        //// soundParametersOutline Drawing
        let soundParametersOutlinePath = UIBezierPath(ovalIn: CGRect(x: soundParamteresFrame.minX + 3, y: soundParamteresFrame.minY + 3, width: soundParamteresFrame.width - 6, height: soundParamteresFrame.height - 6))
        ...
        let soundParametersLightPath = UIBezierPath(ovalIn: CGRect(x: soundParametersLightFrame.minX, y: soundParametersLightFrame.minY, width: soundParametersLightFrame.width, height: soundParametersLightFrame.height))
        UIGroover.buttonsBGLight.setFill()
        soundParametersLightPath.fill()


        //// soundParametersBlue Drawing
        let soundParametersBluePath = UIBezierPath(roundedRect: CGRect(x: soundParametersBlueFrame.minX, y: soundParametersBlueFrame.minY, width: soundParametersBlueFrame.width, height: soundParametersBlueFrame.height), cornerRadius: 2)
        ...
        if (soundParametersSelected) {
            ...
            let soundParametersBlueOutlinePath = UIBezierPath(ovalIn: CGRect(x: soundParametersLightFrame.minX, y: soundParametersLightFrame.minY, width: soundParametersLightFrame.width, height: soundParametersLightFrame.height))
    ...
    public dynamic class func drawKnobCanvas(knobFrame: CGRect = CGRect(x: 1, y: 0, width: 280, height: 280), rotation: CGFloat = 254, clickSelected: Bool = true, clickRingActive: Bool = false) {
        //// General Declarations
        ...
        //// Subframes
        let clickButton: CGRect = CGRect(x: knobFrame.minX + fastFloor((knobFrame.width - 24) * 0.49609 + 0.5), y: knobFrame.minY + fastFloor((knobFrame.height - 24) * 0.50000 + 0.5), width: 24, height: 24)


        //// knobBGFrame Drawing
        let knobBGFrameRect = CGRect(x: knobFrame.minX + fastFloor((knobFrame.width - 281) * 1.00000 + 0.5), y: knobFrame.minY + fastFloor((knobFrame.height - 280) / 2 + 0.5), width: 281, height: 280)
        ...
        //// rotationBevels
        context.saveGState()
        context.translateBy(x: knobFrame.minX + 0.49643 * knobFrame.width, y: knobFrame.minY + 0.50000 * knobFrame.height)
        ...
        if (clickRingActive) {
            //// clickRing Drawing
            let clickRingPath = UIBezierPath(ovalIn: CGRect(x: knobFrame.minX + 80, y: knobFrame.minY + 81, width: knobFrame.width - 162, height: knobFrame.height - 162))
            UIGroover.lightBlue.setStroke()
    ...
    public dynamic class func drawMeasureCanvas(measureFrame: CGRect = CGRect(x: 0, y: 0, width: 82, height: 28), measureActive: Bool = true, measureProgress: CGFloat = 20) {
