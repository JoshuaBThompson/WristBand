...
public class UIGroover : NSObject {
    ...
    public dynamic class func drawMeasureCanvas(measureFrame: CGRect = CGRect(x: 0, y: -2, width: 82, height: 32), measureActive: Bool = true, measureProgress: CGFloat = 20) {
        ...
        let measureBorderPath = UIBezierPath(roundedRect: CGRect(x: measureFrame.minX + 3, y: measureFrame.minY + 3, width: 78, height: 24), cornerRadius: 2)
        ...
        if (measureActive) {
            ...
            let measureActiveFillPath = UIBezierPath(roundedRect: CGRect(x: 3, y: 3, width: measureProgress, height: 24), cornerRadius: 2)
            UIGroover.lightBlue.setFill()
