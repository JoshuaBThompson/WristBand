...
public class UIGroover : NSObject {
    ...
    public dynamic class func drawSliderCanvas(sliderBasicBGFrame: CGRect = CGRect(x: 13, y: 19, width: 188, height: 8), sliderPosition: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Frames
        let sliderHandleFrame = CGRect(x: (sliderPositionOffset - 40), y: -1, width: 44, height: 44)
        ...
        let sliderHandlePath = UIBezierPath(ovalIn: CGRect(x: sliderHandleFrame.minX + fastFloor((sliderHandleFrame.width - 21) * 0.52174 + 0.5), y: sliderHandleFrame.minY + fastFloor((sliderHandleFrame.height - 21) * 0.47826 + 0.5), width: 21, height: 21))
    ...
    public dynamic class func drawPanSliderCanvas(sliderBasicBGFrame: CGRect = CGRect(x: 13, y: 18, width: 188, height: 8), panSliderPosition: CGFloat = 0) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Frames
        let sliderHandleFrame = CGRect(x: (panSliderPositionOffset - 40), y: 0, width: 44, height: 44)
