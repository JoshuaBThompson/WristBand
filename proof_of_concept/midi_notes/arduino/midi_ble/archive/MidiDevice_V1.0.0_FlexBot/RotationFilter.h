...
#define MAX_GYRO_TIME_DIFF  10.0*1000 //time (ms) between resetting the pure gyro sensor angle calculation with that of the averaged accel angle calc
...
class RotationFilter
{
  public:
    ...
    void updateAngleDegGyro(void);
    void updateRotationNumber(void);
