...
//  Groover
//
//  Created by Joshua Thompson on 1/14/17.
...
public extension UIDevice {
    ...
    var modelNameShort: String {
        let longName = modelName
        if(longName == "iPhone 5" || longName == "iPhone 5c" || longName == "iPhone 5s" || longName == "iPhone SE"){
            return "iPhone SE"
        }
