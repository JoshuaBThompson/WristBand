...
public class UIGroover : NSObject {
    ...
    public dynamic class func drawKnobCanvasSE(knobFrame: CGRect = CGRect(x: 0, y: 0, width: 270, height: 270), rotation: CGFloat = 180, clickSelected: Bool = false, clickRingActive: Bool = true) {
        //// General Declarations
        ...
        //// Subframes
        let knobRotation: CGRect = CGRect(x: knobFrame.minX + fastFloor((knobFrame.width - 270) / 2 - 0.5) + 1, y: knobFrame.minY + fastFloor((knobFrame.height - 270) / 2 - 0.5) + 1, width: 270, height: 270)
    ...
    public dynamic class func drawKnobCanvas6and7(knobFrame: CGRect = CGRect(x: 0, y: 0, width: 316, height: 316), rotation: CGFloat = 180, clickSelected: Bool = false, clickRingActive: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Subframes
        let knobRotation: CGRect = CGRect(x: knobFrame.minX + fastFloor((knobFrame.width - 316) / 2 - 0.5) + 1, y: knobFrame.minY + fastFloor((knobFrame.height - 316) / 2 - 0.5) + 1, width: 316, height: 316)
        ...
        knobrotationmaskPath.usesEvenOddFillRule = true
        var knobrotationmaskTransformation = CGAffineTransform.identity
        knobrotationmaskTransformation = knobrotationmaskTransformation.translatedBy(x: knobRotation.minX + 158, y: knobRotation.minY + 157)
        knobrotationmaskTransformation = knobrotationmaskTransformation.rotated(by: -rotation * CGFloat.pi/180)
        knobrotationmaskPath.apply(knobrotationmaskTransformation)
        knobrotationmaskPath.addClip()
        ...
        //// rotationBevels
        context.saveGState()
        context.translateBy(x: knobRotation.minX + 0.50000 * knobRotation.width, y: knobRotation.minY + 0.49367 * knobRotation.height)
        context.rotate(by: -rotation * CGFloat.pi/180)
    ...
    public dynamic class func drawKnobCanvas6and7plus(knobFrame: CGRect = CGRect(x: 0, y: 0, width: 347, height: 347), rotation: CGFloat = 180, clickSelected: Bool = false, clickRingActive: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Subframes
        let knobRotation: CGRect = CGRect(x: knobFrame.minX + fastFloor((knobFrame.width - 347) / 2 - 0.5) + 1, y: knobFrame.minY + fastFloor((knobFrame.height - 347) / 2 + 0.3) + 0.2, width: 347, height: 347)
        ...
        knobrotationmaskPath.usesEvenOddFillRule = true
        var knobrotationmaskTransformation = CGAffineTransform.identity
        knobrotationmaskTransformation = knobrotationmaskTransformation.translatedBy(x: knobRotation.minX + 173.5, y: knobRotation.minY + 172.4)
        knobrotationmaskTransformation = knobrotationmaskTransformation.rotated(by: -rotation * CGFloat.pi/180)
        knobrotationmaskPath.apply(knobrotationmaskTransformation)
        knobrotationmaskPath.addClip()
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: knobRotation.minX + fastFloor(knobRotation.width * 0.00000 + 0.5), y: knobRotation.minY + fastFloor(knobRotation.height * -0.00345 - 0.3) + 0.8, width: fastFloor(knobRotation.width * 1.00000 + 0.5) - fastFloor(knobRotation.width * 0.00000 + 0.5), height: fastFloor(knobRotation.height * 0.99655 - 0.3) - fastFloor(knobRotation.height * -0.00345 - 0.3)))
        context.saveGState()
        ovalPath.addClip()
        let ovalRotatedPath = UIBezierPath()
        ovalRotatedPath.append(ovalPath)
        ...
        //// rotationBevels
        context.saveGState()
        context.translateBy(x: knobRotation.minX + 0.45533 * knobRotation.width, y: knobRotation.minY + 0.44900 * knobRotation.height)
        context.rotate(by: -rotation * CGFloat.pi/180)
    ...
    public dynamic class func drawQuarterCanvas(quarterFrame: CGRect = CGRect(x: 0, y: 0, width: 54, height: 54), quarterSelected: Bool = false, quarterActive: Bool = false, quarterInactive: Bool = false) {
        //// General Declarations
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }

        //// Color Declarations
        let black50 = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.500)
        let lightGray50 = UIColor(red: 0.345, green: 0.392, blue: 0.439, alpha: 0.500)

        //// Variable Declarations
        let quarterDeselected = !quarterSelected && !quarterInactive
        ...
        if (quarterInactive) {
            //// buttonOpacity Drawing
            let buttonOpacityPath = UIBezierPath(roundedRect: CGRect(x: quarterFrame.minX + fastFloor(quarterFrame.width * 0.09259 + 0.5), y: quarterFrame.minY + fastFloor(quarterFrame.height * 0.09259 + 0.5), width: fastFloor(quarterFrame.width * 0.90741 + 0.5) - fastFloor(quarterFrame.width * 0.09259 + 0.5), height: fastFloor(quarterFrame.height * 0.90741 + 0.5) - fastFloor(quarterFrame.height * 0.09259 + 0.5)), cornerRadius: 6)
            black50.setFill()
            buttonOpacityPath.fill()
        }
        ...
        if (quarterInactive) {
            ...
            quarterOpacityPath.addLine(to: CGPoint(x: quarterIconFrame.minX + 0.79016 * quarterIconFrame.width, y: quarterIconFrame.minY + 0.00000 * quarterIconFrame.height))
            quarterOpacityPath.addLine(to: CGPoint(x: quarterIconFrame.minX + 0.95683 * quarterIconFrame.width, y: quarterIconFrame.minY + 0.00000 * quarterIconFrame.height))
            quarterOpacityPath.addLine(to: CGPoint(x: quarterIconFrame.minX + 0.95683 * quarterIconFrame.width, y: quarterIconFrame.minY + 0.80000 * quarterIconFrame.height))
            quarterOpacityPath.addLine(to: CGPoint(x: quarterIconFrame.minX + 0.95501 * quarterIconFrame.width, y: quarterIconFrame.minY + 0.80000 * quarterIconFrame.height))
            quarterOpacityPath.addLine(to: CGPoint(x: quarterIconFrame.minX + 0.95501 * quarterIconFrame.width, y: quarterIconFrame.minY + 0.80000 * quarterIconFrame.height))
            quarterOpacityPath.close()
            quarterOpacityPath.usesEvenOddFillRule = true
            lightGray50.setFill()
            quarterOpacityPath.fill()
        }
    ...
    public dynamic class func drawRecordCanvas(recordFrame: CGRect = CGRect(x: 0, y: 0, width: 87, height: 56), recordSelected: Bool = false, recordTransitioning: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        // This non-generic function dramatically improves compilation times of complex expressions.
        func fastFloor(_ x: CGFloat) -> CGFloat { return floor(x) }
        ...
        //// Color Declarations
        let color4 = UIGroover.transportRed.withAlpha(0.5)
        ...
        if (recordTransitioning) {
            //// Oval Drawing
            let ovalPath = UIBezierPath(ovalIn: CGRect(x: recordFrame.minX + fastFloor((recordFrame.width - 22.5) * 0.49612 + 0.5), y: recordFrame.minY + fastFloor((recordFrame.height - 22.5) * 0.50746 + 0.5), width: 22.5, height: 22.5))
            color4.setFill()
            ovalPath.fill()
            UIGroover.transportRed.setStroke()
