...
public class UIGroover : NSObject {
    ...
    public dynamic class func drawKnobCanvas6and7plus(rotation: CGFloat = 0, clickSelected: Bool = false, clickRingActive: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        knobrotationmaskPath.usesEvenOddFillRule = true
        var knobrotationmaskTransformation = CGAffineTransform.identity
        knobrotationmaskTransformation = knobrotationmaskTransformation.translatedBy(x: 228, y: 229.44)
        knobrotationmaskTransformation = knobrotationmaskTransformation.rotated(by: -rotation * CGFloat.pi/180)
        knobrotationmaskPath.apply(knobrotationmaskTransformation)
        knobrotationmaskPath.addClip()
        ...
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 0, y: 1, width: 456, height: 456))
        context.saveGState()
        ovalPath.addClip()
        context.drawLinearGradient(rotationGradientBG, start: CGPoint(x: 66.78, y: 67.78), end: CGPoint(x: 389.22, y: 390.22), options: [])
        context.restoreGState()


        //// rotationBevels
        context.saveGState()
        context.translateBy(x: 228, y: 228)
        context.rotate(by: -rotation * CGFloat.pi/180)
        ...
        if (clickRingActive) {
            //// clickRing Drawing
            let clickRingPath = UIBezierPath(ovalIn: CGRect(x: 128, y: 128, width: 200, height: 200))
            UIGroover.lightBlue.setStroke()
            clickRingPath.lineWidth = 2
            clickRingPath.stroke()
        }
        ...
        //// clickOval7 Drawing
        context.saveGState()
        context.translateBy(x: 228.5, y: 245.88)
        ...
        //// clickOval6 Drawing
        let clickOval6Path = UIBezierPath(ovalIn: CGRect(x: 204, y: 240, width: 12, height: 12))
        clickColor.setFill()
        clickOval6Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval6Path.lineWidth = 1
        ...
        //// clickOval5 Drawing
        let clickOval5Path = UIBezierPath(ovalIn: CGRect(x: 241, y: 221, width: 12, height: 13))
        clickColor.setFill()
        clickOval5Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval5Path.lineWidth = 1
        ...
        //// clickOval4 Drawing
        let clickOval4Path = UIBezierPath(ovalIn: CGRect(x: 222, y: 221, width: 13, height: 13))
        clickColor.setFill()
        clickOval4Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval4Path.lineWidth = 1
        ...
        //// clickOval3 Drawing
        let clickOval3Path = UIBezierPath(ovalIn: CGRect(x: 204, y: 221, width: 12, height: 13))
        clickColor.setFill()
        clickOval3Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval3Path.lineWidth = 1
        ...
        //// clickOval2 Drawing
        let clickOval2Path = UIBezierPath(ovalIn: CGRect(x: 241, y: 203, width: 12, height: 12))
        clickColor.setFill()
        clickOval2Path.fill()
        UIGroover.clickDarkGray.setStroke()
        clickOval2Path.lineWidth = 1
        ...
        //// clickOval1 Drawing
        context.saveGState()
        context.translateBy(x: 228.5, y: 209.12)
